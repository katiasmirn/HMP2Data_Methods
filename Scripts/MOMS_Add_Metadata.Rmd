...
init <- read.table(paste(path2, filelist[9], sep=""), fill = TRUE, header = FALSE, sep = "", dec = ".")
...
#Read in second file
second <- read.table(paste(path2, filelist[2], sep=""), fill = TRUE, header = FALSE, sep = "", dec = ".")
...
for (i in 3:7) {
  file <- read.table(paste(path2, filelist[i], sep=""), fill = TRUE, header = FALSE, sep = "\t", dec = ".")
