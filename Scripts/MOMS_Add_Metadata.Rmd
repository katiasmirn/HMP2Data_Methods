...
health_history <- health_history[,-(which(names(health_history) == "visit_num"))] #Column not needed
health_history <- health_history[,-(which(names(health_history) == "visit_ID"))] #Column not needed
